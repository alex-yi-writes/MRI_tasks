...
taskpath       = 'C:\Users\ibmi\Downloads\Desktop\pilot_7T\BlueLight\';
...
input_prompt = {'ID (e.g. 4001)';'GROUP (1 = YAs, 2= OAs)';'1=main task, 2=memory test'; ...
...
elseif TaskType == 2 % test
    eyetracker_filename = ['br' num2str(ID) '.edf'];
    
    [dat] = runBlueLightTest_cg(ID,AgeGroup,EyeFlag,MRIFlag,eyetracker_filename,path_ECHO);
