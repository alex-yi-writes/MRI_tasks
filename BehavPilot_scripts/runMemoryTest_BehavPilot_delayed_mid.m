...
function [dat] = runMemoryTest_BehavPilot_delayed_mid(ID,TaskType,EyeFlag,MRIFlag,CnterBal,eyetracker_filename,DayNumber,Schedules,PATH_echo)
...
paths.stim     = [ paths.parent 'pilot_3T\stim_original\' ];  %%%%% changed
end
paths.fb       = [ paths.parent 'pilot_3T\feedback\' ];
paths.pupil    = [ paths.parent 'pilot_Behav\raw\pupil\' ];
paths.behav    = [ paths.parent 'pilot_Behav\raw\behav\' ];
